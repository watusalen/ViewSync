...
```bash
INIT=$(node "C:/Users/Kellviny/Documents/GitHub/ViewSync/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Kellviny/Documents/GitHub/ViewSync/.gemini/get-shit-done/templates/spec.md.
