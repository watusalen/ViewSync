...
```
Task(
  prompt="Read C:/Users/Kellviny/Documents/GitHub/ViewSync/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Kellviny/Documents/GitHub/ViewSync/.gemini/get-shit-done/templates/SECURITY.md`
